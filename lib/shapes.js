...
class RenderShape {
    ...
    shapeTemplate() {
        ...
        if (this.shape === "circle") {
            ...
            chosenShape = new Triangle({ shapeColor: this.shapeColor });
        } else if (this.shape === "square") {
            chosenShape = new Square({ shapeColor: this.shapeColor });
        }

        const svgHTML = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
        ...
        fs.writeFile("./examples/Logo.svg", svgHTML, (err) =>
